...
public class VictoryScreen extends BaseScreen {
	...
	public VictoryScreen(MissingWords missingWords) {
		...
		/* Creamos la etiqueta con el título "Played Words" */
		
		playedWords = new Label("Played\nWords", new LabelStyle(font, font.getColor()));
	...
	public void show() {	
		...
		/* Creamos el array de strings con las palabras que se han jugado */
		
		wordArray =  missingWords.getGameScreen().getPlayedWords().toArray(
